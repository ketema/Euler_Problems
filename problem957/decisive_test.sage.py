...
# This file was *autogenerated* from the file decisive_test.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_70 = Integer(70); _sage_const_3 = Integer(3); _sage_const_9 = Integer(9); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_7 = Integer(7)
...
def line_intersection(p1, p2, p3, p4):
    ...
    d1 = p2 - p1
    d2 = p4 - p3
    det = d1[_sage_const_0 ]*(-d2[_sage_const_1 ]) - d1[_sage_const_1 ]*(-d2[_sage_const_0 ])
    if det == _sage_const_0 :
        return None  # Parallel or coincident
    rhs = p3 - p1
    t = (rhs[_sage_const_0 ]*(-d2[_sage_const_1 ]) - rhs[_sage_const_1 ]*(-d2[_sage_const_0 ])) / det
    return p1 + t*d1
...
def compute_day_1(reds, initial_blues):
    ...
    for i, (p1, p2) in enumerate(lines):
        for (p3, p4) in lines[i+_sage_const_1 :]:
...
# Fixed red points
R1 = vector(QQ, [_sage_const_0 , _sage_const_0 ])
R2 = vector(QQ, [_sage_const_1 , _sage_const_0 ])
R3 = vector(QQ, [_sage_const_0 , _sage_const_1 ])
reds = [R1, R2, R3]
...
config_A = [vector(QQ, [_sage_const_1 , _sage_const_1 ]), vector(QQ, [_sage_const_3 , _sage_const_9 ])]
...
config_B = [vector(QQ, [_sage_const_2 , _sage_const_3 ]), vector(QQ, [_sage_const_5 , _sage_const_7 ])]
